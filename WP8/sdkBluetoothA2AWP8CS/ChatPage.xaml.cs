    ...
    public partial class ChatPage : PhoneApplicationPage
    {
        ...
        async void ConnectToPeer(PeerInformation peer)
        {
            try
            {
                ...
                System.Threading.ThreadPool.QueueUserWorkItem(ListenForIncomingMessage,null);
            }
            catch (Exception ex)
            {
        ...
        private async void ListenForIncomingMessage(object x)
        {
            try
            {
