...
namespace BluetoothRfcommChat
{
    ...
    /// </summary>
    public sealed partial class S1_ChatServer : SDKTemplate.Common.LayoutAwarePage
    {
            ...
            StreamSocketListener sender, StreamSocketListenerConnectionReceivedEventArgs args)
        {
            try
            {
                ...
                while (true)
                {
                    //string testMessage = "testing " + i++;
                    //writer.WriteUInt32((uint)testMessage.Length);
